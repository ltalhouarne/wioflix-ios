...
angular.module('Wioflix.controllers', [])
    ...
    .controller('imdbCtrl', function ($scope, $stateParams, $state, $http, $window, $ionicPopup, $ionicScrollDelegate) {
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/imdbMovies.json?version=' + $scope.parentobj.random
        ...
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/imdbTV.json?version=' + $scope.parentobj.random
        }).success(function (data) {
        ...
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/imdbCategories.json?version=' + $scope.parentobj.random
        }).success(function (data) {
    ...
    .controller('mcCtrl', function ($scope, $stateParams, $state, $http, $window, $ionicPopup, $ionicScrollDelegate) {
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/mcCritic.json?version=' + $scope.parentobj.random
        }).success(function (data) {
            $scope.posts = data; // response data
        ...
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/mcUser.json?version=' + $scope.parentobj.random
        }).success(function (data) {
            $scope.posts2 = data; // response data
        ...
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/mcGenres.json?version=' + $scope.parentobj.random
        }).success(function (data) {
            $scope.posts3 = data; // response data
    ...
    .controller('rtCtrl', function ($scope, $stateParams, $state, $http, $window, $ionicPopup, $ionicScrollDelegate) {
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/rtMoviesCritic.json?version=' + $scope.parentobj.random
        }).success(function (data) {
            $scope.posts = data; // response data
        ...
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/rtMoviesUser.json?version=' + $scope.parentobj.random
        }).success(function (data) {
            $scope.posts2 = data; // response data
        ...
        $http({
            method: 'GET',
            url: 'http://whatisonnetflix.com/js/rtCategories.json?version=' + $scope.parentobj.random
        }).success(function (data) {
            $scope.posts3 = data; // response data
        });
    ...
    .controller('randomCtrl', function ($scope, $stateParams, $state, $http, $window, $ionicPopup, $ionicScrollDelegate) {
        ...
        $http({
            method : 'GET',
            url : 'http://whatisonnetflix.com/js/allCats.json?version=' + $scope.parentobj.random
        }).success(function(data) {
            $scope.posts3 = data; // response data
        });
        ...
        $http({
            method : 'GET',
            url : 'http://whatisonnetflix.com/js/allM.json?version=' + $scope.parentobj.random
        }).success(function(data) {
            $scope.posts2 = data; // response data
            shuffleArray($scope.posts2);
        });
